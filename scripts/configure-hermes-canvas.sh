...
cat > ~/.hermes/memories/MEMORY.md <<'MEMORY'
# Persistent Notes

- The configured MIT Canvas course is course 37338 at https://canvas.mit.edu/courses/37338.
- The course title is "MAS.664 AI Studio: AI Agents and Agentic Web (AI for Impact)".
...
- To inspect the configured Canvas course, run ~/.hermes/scripts/canvas-course-snapshot.sh or use Canvas REST API GET endpoints.
MEMORY

cat > ~/.hermes/memories/USER.md <<'USER'
# User Profile

- The user is Nikolay Vyahhi.
- The user's Telegram ID is 152157536.
- The user has configured Hermes Telegram access through @nicolawmitbot.
- The user wants Hermes to answer questions about MIT Canvas course 37338.
USER
